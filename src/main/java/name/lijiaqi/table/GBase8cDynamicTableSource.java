 ...
 * @author lijiaqi
 */
public class GBase8cDynamicTableSource implements ScanTableSource {

    private final JdbcOptions options;
    private final TableSchema tableSchema;

    public GBase8cDynamicTableSource(JdbcOptions options, TableSchema tableSchema) {
    ...
    public DynamicTableSource copy() {
        return new GBase8cDynamicTableSource(options, tableSchema);
    }
