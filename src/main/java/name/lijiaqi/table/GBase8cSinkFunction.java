 ...
 * @author lijiaqi
 */
public class GBase8cSinkFunction extends RichSinkFunction<RowData> {
...
//    private String sql  = "insert into";
    ...
    public GBase8cSinkFunction(JdbcOptions jdbcOptions) {
        this.jdbcOptions = jdbcOptions;
//        this.serializationSchema = serializationSchema;
    }

    public GBase8cSinkFunction(JdbcOptions jdbcOptions, DataType dataType) {
        this.jdbcOptions = jdbcOptions;
